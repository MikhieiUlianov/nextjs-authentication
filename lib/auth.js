...
export async function verifyAyth() {
...
/* 
so and that is answer to my questin, that we can have only one session, because it is logic that we jsut cant have tqo session on the same account. so and it is easi to gwet session in this case then: */
